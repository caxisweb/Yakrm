...
import devsupport.ai.peachpay.REST.API;
import devsupport.ai.peachpay.REST.RestClass;
...
public class PeachPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if (checkValidation()) {
        ...
        getCheckoutIDModelCall.enqueue(new retrofit2.Callback<GetCheckoutIDModel>() {
            @Override
...
*/
            ...
            public void onFailure(Call<GetCheckoutIDModel> call, Throwable t) {
                Toast.makeText(PeachPay.this, "Server Error", Toast.LENGTH_SHORT).show();
            }
        });
    }
